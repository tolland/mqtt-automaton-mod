...
def demo_behavior_engine():
    ...
    engine.update_context({"pillager_attack": True, "pillager_data": {"threat_level": "high"}})
...
def demo_emergency_handling():
    ...
    scenarios = [
        {"name": "Pillager Attack", "context": {"pillager_attack": True, "pillager_data": {"threat_level": "high"}}},
        {"name": "Player Detection", "context": {"player_detected": True, "player_data": {"name": "Player123"}}},
        {"name": "Low Health", "context": {"low_health": True, "health_data": {"health": 5}}}
    ]
