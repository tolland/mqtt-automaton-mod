...
public interface InventoryListener extends Listener {
     ...
     */
    void onInventoryChange(Map<String, Integer> itemCounts, int emptySlots, int fullSlots);
     ...
     */
    void onItemCountChange(String itemId, int oldCount, int newCount, int totalCount);
    ...
    class InventoryChangeEvent extends Event<InventoryListener> {
        ...
        public InventoryChangeEvent(Map<String, Integer> itemCounts, int emptySlots, int fullSlots) {
    ...
    class ItemCountChangeEvent extends Event<InventoryListener> {
        ...
        public ItemCountChangeEvent(String itemId, int oldCount, int newCount, int totalCount) {
            this.itemId = itemId;
        ...
        public void fire(ArrayList<InventoryListener> listeners) {
            for (InventoryListener listener : listeners) {
                listener.onItemCountChange(itemId, oldCount, newCount, totalCount);
            }
        }
