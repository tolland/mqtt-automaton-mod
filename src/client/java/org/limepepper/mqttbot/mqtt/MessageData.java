...
public class MessageData {
    ...
    private String service;        // Target service/module (e.g., "baritone", "inventory", "chat")
    private String method;         // Method to call on the service (e.g., "goto", "mine", "say")
    private String requestId;      // Unique request identifier
    private String correlationId;  // Correlation ID for request/response tracking
    ...
    private String identity;       // Source of the message (e.g., "python_client", "web_dashboard")
    ...
    // Full constructor
    public MessageData(String service, String method, String requestId, String correlationId,
                       JsonObject params, JsonObject response, String identity, String message) {
    ...
    public MessageData(String service, String method, String requestId, String correlationId,
                       JsonObject params, String identity, String message) {
        this(service, method, requestId, correlationId, params, null, identity, message);
    }
    ...
    public static MessageData fromJson(String jsonString) {
        try {
            ...
            System.err.println("Failed to parse MQTT message JSON: " + e.getMessage());
    ...
    public String toString() {
        return String.format("MqttMessage{service='%s', method='%s', requestId='%s', correlationId='%s', identity='%s', hasParams=%s, hasResponse=%s, message='%s'}",
                service, method, requestId, correlationId, identity, (params != null), (response != null), message);
    }
}
