...
public enum BotTestHelper {
     ...
     *
     * @param context the test context
     * @param absX    player x coordinate
     * @param absY    player y coordinate
     * @param absZ    player z coordinate
     */
    ...
    /**
     * Waits for exactly one item of the specified type to appear in the given inventory slot.
     * This method combines waiting and checking in a single client thread deferral to avoid
     * double-deferring issues.
     *
     * @param context the test context
     * @param slot    the inventory slot to check
     * @param item    the expected item type
     */
    public static void waitForOneItemInSlot(
